...
<div id="wrapper">
    ...
    <div class="content">
        ...
        <?php
            ...
            if(isset($_GET['id']))
            {
                ...
                if(filter_var($id, FILTER_VALIDATE_INT))
                {
                    ...
                    while($red=$db->fetch_object($rez))
                    {
                        ...
                        while($redslike=$db->fetch_object($sveslike))
                            echo "'slike/".$redslike->imeSlike."',";
                            //"slike/1.jpg", "slike/2.jpg", "slike/3.jpg", "slike/4.jpg", "slike/5.jpg"
                        echo "];</script>";
                        echo "<center><div id='galerija'></div>";
                        echo "<p>".$red->tekst."<p>";
          ...
          ?>
          <br><br>
            <input type="checkbox" id="potvrda" onclick="prikaziFormu()"> Da li zelite da ostavite komentar? <br><br>
            <form action="proizvodi.php?id=<?= $id?>" method="post" onsubmit="return proveriFormu()"style="display:none" id="forma">
